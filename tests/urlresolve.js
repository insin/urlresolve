QUnit.module('urlresolve')

;(function() {

var URLPattern = urlresolve.URLPattern
  , URLResolver = urlresolve.URLResolver
  , ResolverMatch = urlresolve.ResolverMatch
  , Resolver404 = urlresolve.Resolver404
