...
var is = server ? require('isomorph/is') : __global__.is
  , func = server ? require('isomorph/func') : __global__.func
  , format = server ? require('isomorph/format') : __global__.format
  , re = server ? require('isomorph/re') : __global__.re
...
if (server) {
  ...
  __global__.urlresolve = urlresolve
}
