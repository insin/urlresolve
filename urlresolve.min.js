...
a);this.namedParams.length&&(a=a.replace(n,"([^/]*)"));return a}function h(a,e,k){this.pattern=a;this.regex=RegExp("^"+j.call(this,a)+"$");m.Function(e)?(this.callback=e,this.callbackName=null):(this.callback=null,this.callbackName=e);this.name=k}function i(a,e){this.pattern=a;this.regex=RegExp("^"+j.call(this,a));this.urlPatterns=e||[];this._reverseLookups=null}function o(a,e,k){if(m.Array(e))return new i(a,e);if(m.String(e)&&!e)throw Error("Empty URL pattern view name not permitted (for pattern "+
a+")");return new h(a,e,k)}var m=a("isomorph/lib/is"),q=a("isomorph/lib/func"),l=a("isomorph/lib/format"),s=a("isomorph/lib/re"),t=Array.prototype.slice;d.prototype.toString=function(){return"Resolver404 on "+this.path};g.prototype.toString=function(){return"NoReverseMatch: "+this.message};var n=/:([\w\d]+)/g,r=/[-[\]{}()*+?.,\\^$|#\s]/g;h.prototype.toString=function(){return l.formatObj('[object URLPattern] <{name} "{pattern}">',this)};h.prototype.addContext=function(a){a&&this.callbackName&&(this.callback=
